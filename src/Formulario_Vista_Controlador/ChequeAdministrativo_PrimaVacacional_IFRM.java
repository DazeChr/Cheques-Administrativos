...
import Clases_Modelo.ChequeAdministrativo_PrimaVacacional_Clase_Derivada;
 ...
 */
public class ChequeAdministrativo_PrimaVacacional_IFRM extends javax.swing.JInternalFrame {

    //Objeto para formatear la impresión de resultados
    public static DecimalFormat Decf = new DecimalFormat("#,###.00");
    
    ChequeAdministrativo_PrimaVacacional_Clase_Derivada Obj_PrimaVacacional;
    
    /**
     * Creates new form ChequeAdministrativo_PrimaVacacional_IFRM
     */
    public ChequeAdministrativo_PrimaVacacional_IFRM() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Cheque Administrativo de Prima Vacacional");
        ...
        jLabel1.setText("PRIMA VACACIONAL");
        ...
        Anos_Trabajados.setText("AÑOS TRABAJADOS.:");
        ...
        Horas_Extras.setText("PRIMA VACACIONAL.:");
        ...
        Escritorio.add(AT, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 410, 260, 30));
    ...
    private void Ejecutar_Algoritmo() {
        ...
        Obj_PrimaVacacional = new ChequeAdministrativo_PrimaVacacional_Clase_Derivada(nombreEmp, deptoEmp, puestoEmp, sueldoDiarioEmp, variableAT);

        //Proceso
        Obj_PrimaVacacional.SetYearsWorked(variableAT);
        Obj_PrimaVacacional.setDias();
        Obj_PrimaVacacional.setSueldoDiario();

        //Salida
        Impresion.setText(null);
        Impresion.append("===========> Prima Vacacional <===========\n");
        Impresion.append("Nombre: " + nombreEmp + "\n");
        Impresion.append("Departamento: " + deptoEmp + "\n");
        Impresion.append("Puesto: " + puestoEmp + "\n");
        Impresion.append("Prima Vacacional: $"+String.valueOf(Decf.format(Obj_PrimaVacacional.getSueldoDro())+"\n"));
        Impresion.append("--------------------------------------------------------------------\n\n");
    }
